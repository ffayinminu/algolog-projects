...
### 5.5 Interactive Drill-Down Features

**CRITICAL: These interactive features are core to the client experience**

#### 5.5.1 Expandable Category Rows

When user taps/clicks a category row, it expands to show details:

```
┌─────────────────────────────────────────────────────────────┐
│ ▼ Generator Health    82/100  🟡GOOD  2 issues  ₦80,000    │
├─────────────────────────────────────────────────────────────┤
│  ┌───────────────────────────────────────────────────────┐  │
│  │ CHECKPOINTS                                           │  │
│  │ ✓ Oil level checked                                   │  │
│  │ ✓ Battery tested - 12.6V                              │  │
│  │ ✓ Fuel quality checked                                │  │
│  │ ✗ Load test performed (FAILED)                        │  │
│  │ ✓ Exhaust system checked                              │  │
│  │                                                       │  │
│  │ ISSUES (tap to view details)                          │  │
│  │ • Oil slightly dark                            [→]    │  │
│  │ • Battery terminals corroded                   [→]    │  │
│  │                                                       │  │
│  │ COST BREAKDOWN (tap to view itemized)                 │  │
│  │ Total: ₦80,000                                 [→]    │  │
│  │                                                       │  │
│  │ [📷 View 3 Photos]                                    │  │
│  └───────────────────────────────────────────────────────┘  │
...
**Interaction:**
- Tap row header to expand/collapse
- Chevron rotates (▶ → ▼) on expand
- Smooth animation (300ms ease-out)
- Only one category expanded at a time (accordion style)

---

#### 5.5.2 Cost Breakdown Modal

When user taps repair cost (e.g., ₦80,000), show itemized breakdown:

```
┌─────────────────────────────────────────────────────────────┐
│  ✕  Cost Breakdown: Generator Health                        │
├─────────────────────────────────────────────────────────────┤
│                                                              │
│  ┌─────────────────────────────────────────────────────────┐│
│  │ Item              Qty    Unit Price    Total            ││
│  ├─────────────────────────────────────────────────────────┤│
│  │ Engine Oil        4L     ₦12,500       ₦50,000    [📷]  ││
│  │ (Mobil 1 5W-30)                                         ││
│  │ Receipt: #INV-2026-001                                  ││
│  ├─────────────────────────────────────────────────────────┤│
│  │ Oil Filter        1      ₦15,000       ₦15,000    [📷]  ││
│  │ (Toyota Genuine)                                        ││
│  │ Receipt: #INV-2026-002                                  ││
│  ├─────────────────────────────────────────────────────────┤│
│  │ Battery Terminal  1      ₦5,000        ₦5,000           ││
│  │ Cleaning Service                                        ││
│  ├─────────────────────────────────────────────────────────┤│
│  │ Labour            2hrs   ₦5,000        ₦10,000          ││
│  └─────────────────────────────────────────────────────────┘│
│                                                              │
│  ┌─────────────────────────────────────────────────────────┐│
│  │                              TOTAL:    ₦80,000          ││
│  └─────────────────────────────────────────────────────────┘│
│                                                              │
│  [📷] = Tap to view receipt/item photo                      │
│                                                              │
└─────────────────────────────────────────────────────────────┘
```
...
- Dark overlay behind modal (rgba(0,0,0,0.5))
- Close button (✕) top right
- Scrollable if many items
- Photo icon opens image viewer

---

#### 5.5.3 Issues Detail Modal

When user taps issues count (e.g., "2 issues"), show details:

```
┌─────────────────────────────────────────────────────────────┐
│  ✕  Issues: Generator Health                                │
├─────────────────────────────────────────────────────────────┤
│                                                              │
│  ┌─────────────────────────────────────────────────────────┐│
│  │  ⚠️ ISSUE 1                              Severity: MED  ││
│  │  ─────────────────────────────────────────────────────  ││
│  │  Oil slightly dark                                      ││
│  │                                                         ││
│  │  Description:                                           ││
│  │  Oil color indicates it's nearing change interval.      ││
│  │  Current color is dark amber instead of golden.         ││
│  │                                                         ││
│  │  Recommendation:                                        ││
...
#### 5.5.4 Quality Verification Indicators

Show verification status for each item:
...
│  │                                                       │  │
│  │ Brand: Unknown ⚠️                                     │  │
│  │ Condition: Claims "New" ⚠️                            │  │
│  │ Receipt: Missing ✗                                    │  │
│  │ Photo: Not provided ✗                                 │  │
│  │                                                       │  │
│  │ [Request Verification from Inspector]                 │  │
│  └───────────────────────────────────────────────────────┘  │
└─────────────────────────────────────────────────────────────┘
```
...
**The dashboard MUST work on all devices:**

| Device | Width | Layout Adjustments |
|--------|-------|-------------------|
| Mobile | < 480px | Single column, stacked cards, bottom sheet modals |
| Tablet | 481-768px | 2-column grid, side modals |
| Laptop | 769-1024px | Full table view, centered modals |
...
- Category rows stack vertically when expanded
- Cost breakdown shows as cards, not table

---

### 5.7 Executive Summary Page (Detailed Reports)
